...
let data =
  TestUtil.make_string_odd [
    ...
    0xbd01; 0x43fe; 0x8afe; 0xaa01; 0x56fe; 0x76fe; 0x9401;
  ] 0x6c
...
let expected =
  ...
  let description =
    ...
    TestUtil.make_string_odd [
      0x40ff; 0x1a16; 0x1402; 0x3a14; 0x2f02; 0x3c2f; 0x3d02; 0x4124;
      0x1e02; 0x043d; 0x0003; 0x0720; 0x3f02; 0x433f; 0x4402; 0x4827;
      0x260e; 0x0444; 0x4603; 0x4a11; 0x1003; 0x464b; 0x034f; 0x210a;
      0x0251; 0x4d52; 0x0236; 0x322d; 0x2918; 0x050d; 0x1655; 0x540d;
      0x0c09; 0x0806; 0x0d52; 0x3938; 0x302f; 0x0359; 0x563e; 0x3d03;
      0x5857; 0x403f; 0x035d; 0x5a45; 0x4403; 0x5c5b; 0x4746; 0x0361;
      0x5e4c; 0x4b03; 0x605f; 0x4e4d; 0x0353; 0x5201; 0x1716; 0x011c;
      0x1b15; 0x1403; 0x0100; 0x0123; 0x2001; 0x2221; 0x010b; 0x0a01;
      0x0e00; 0x0e38; 0x3002; 0x3e58; 0x032b; 0x2f2d; 0x2b29; 0x0458;
      0x5303; 0x0427; 0x261b; 0x1a04; 0x0524; 0x0703; 0x1817; 0x0203;
      0x0709; 0x031c; 0x0100; 0x0309; 0x0b03; 0x1e14; 0x020b; 0x0d03;
      0x5251; 0x4f4e; 0x4b4a; 0x4847; 0x4443; 0x4140; 0x3d3c; 0x3a39;
      0x3632; 0x120d; 0x343e; 0x1615; 0x1110; 0x040d; 0x0d61; 0x605d;
      0x5c59; 0x581e; 0x053e; 0x5f5e; 0x5b5a; 0x5756; 0x5453; 0x1e07;
      0x2408; 0x071e; 0x0109; 0x2120; 0x0c0b; 0x1e03; 0x0d04; 0x044d;
      0x4c46; 0x453f; 0x3e05; 0x5524; 0x0123; 0x220a; 0x0903; 0x0e0d;
      0x01b1; 0x0400; 0x2a2a; 0x102a; 0x10c4; 0x2a2b; 0x2b2b; 0x2b2f;
      0x2b2f; 0x2b2b; 0x2a10; 0x2a10; 0x2a2b; 0x2b2b; 0x2b2b; 0x2b2b;
      0x2b2b; 0x2b31;
    ] 0x30)
  in
